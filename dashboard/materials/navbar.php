<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            ...
            <div class="input-group search-input">
              <img src="../materials/header_logo_1.png" width="200" class="imagen-izquierda">
              ...
              <ul class="navbar-nav ms-auto navbar-list mb-2 mb-lg-0 align-items-center">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="../materials/GOD.png" alt="User-Profile" class="img-fluid avatar avatar-50 avatar-rounded">
                    <div class="caption ms-3 ">
                        <h6 class="mb-0 caption-title">Miguel Gómez</h6>
                        <p class="mb-0 caption-sub-title">Super Admin</p>
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li class="border-0"><a class="dropdown-item" href="../views/perfil_usuario.php">Perfil</a></li>
                    <li class="border-0"><a class="dropdown-item" href="../dashboard/app/user-privacy-setting.html">Configuración</a></li>
                    <li class="border-0"><hr class="m-0 dropdown-divider"></li>
                    <li class="border-0"><a class="dropdown-item" href="../dashboard/auth/sign-in.html">Cerrar Sesión</a></li>
                  </ul>
                </li>
              </ul>
            </div>
